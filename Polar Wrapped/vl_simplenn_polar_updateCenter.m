function [net,imdb,res_c] = vl_simplenn_polar_updateCenter(net,im ,atten_LR,isFliped ,imdb,batch,isMaximize,res_c,opts,s)
   %% function [net,imdb,res_unc] = vl_simplenn_polar_train(net,im ,...
   % ... atten_LR,isFliped ,imdb,batch,isMaximize,res_c,opts,s)
   % this function gets the net with polar layer (and centers already
   % uploaded into the polar layer) 
   % 
